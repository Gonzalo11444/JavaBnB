...
/**
 * JFrame que permite consultar los inmuebles existentes en el sistema
 * @author Pc
 */
public class ConsultaInmuebles extends javax.swing.JFrame {
     ...
     */
    public ConsultaInmuebles(JFrame ventana) {
        initComponents();
    ...
    private void initComponents() {
        ...
        MediaRseñas = new javax.swing.JLabel();
        ...
        MediaRseñas.setBackground(new java.awt.Color(51, 51, 51));
        MediaRseñas.setFont(new java.awt.Font("Tw Cen MT Condensed Extra Bold", 0, 18)); // NOI18N
        MediaRseñas.setText("Media Reseñas");
                        ...
                        .addGroup(FondoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(FondoLayout.createSequentialGroup()
                                .addGroup(FondoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(Anterior, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 181, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGroup(FondoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(FondoLayout.createSequentialGroup()
                                        .addGap(35, 35, 35)
        ...
        FondoLayout.setVerticalGroup(
            ...
            .addGroup(FondoLayout.createSequentialGroup()
                ...
                .addGroup(FondoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(MediaRseñas, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        setSize(new java.awt.Dimension(776, 682));
...
/**
 * Boton que permite visualizar el siguiente inmueble del anfitrion
 * @param evt 
 */
...
// Verificar si la lista no está vacía
        if (!listaInmuebles.isEmpty()) {
            ...
            if (Metodos.inmuebleActualIndex < 0) {
                Metodos.inmuebleActualIndex = listaInmuebles.size() - 1;
            }

            // Si el índice es mayor o igual al tamaño de la lista, volver al primer inmueble
            if (Metodos.inmuebleActualIndex >= listaInmuebles.size()) {
                Metodos.inmuebleActualIndex = 0;
            }

            // Obtener el inmueble actual
            Inmueble inmuebles = listaInmuebles.get(Metodos.inmuebleActualIndex);
            ...
            txtMediaResenas.setValue(inmuebles.getCalificacion());
            ...
            // Manejar el caso donde la lista de inmuebles está vacía
...
/**
 * Boton para retroceder a la ventana de administrador
 * @param evt 
 */
...
/**
 * ^Metodo que permite cargar la imagen como ByteArray
 * @param file
 * @return bytearray
 * @throws IOException 
 */
...
/**
 * Botón que permite visualizar el anterior inmueble
 * @param evt 
 */
...
// Verificar si la lista no está vacía
    ...
    private javax.swing.JLabel MediaRseñas;
